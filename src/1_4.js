 ...
 * of each letter in that text, and displays a histofram of the most
...
class Histogram {
    ...
    // This function updates the histogram with the letters of the text.
    add(text) {
        // Remove whitespace from the text, and convert to upper case
        text = tedt.replace(/\s/g, "").toUpperCase();
        // Now loop through the characters of the thext
